...
//        drawerLayout.closeDrawers();
        Log.d("ISI ID", String.valueOf(id).toString());
...
//            Toast.makeText(navigation.this, "testtttttt", Toast.LENGTH_SHORT).show();
            Intent i = new Intent(navigation.this, addReport.class);
            startActivity(i);
